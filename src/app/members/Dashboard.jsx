...
import TransactionTable from "@/app/dashboard/members/components/TransactionTable";
import PurchasesTable from "@/app/dashboard/members/components/PurchasesTable";
import RewardsTable from "@/app/dashboard/members/components/RewardsTable";
  ...
  useEffect(() => {
    ...
    const fetchUserInfo = async () => {
      try {
        ...
        const url = `http://${API_BASE_URL}/v1/member/`;
        ...
        setUser(data.data); // Set user state with fetched data
            ...
            <Card className="w-full flex flex-col">
              <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full flex-1 flex flex-col">
                                  ...
                                  <Card className="w-full">
                                    <CardContent className="space-y-4 w-full">
                                      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-2 mt-3">
                                        ...
                                        <DashboardCard title="Wallet Balance" icon={<WalletMinimal/>} value={user.wallet.wallet_balance} changeColor="text-blue-500" change=""/>

                                        <DashboardCard title="Reward Points" icon={<WalletMinimal className="h-4 w-4 text-muted-foreground"/>} value={user.wallet.reward_points} changeColor="text-blue-500" change="Convert Rewards"/>
                ...
                <CardContent className="flex-1 overflow-y-auto p-4">
                  ...
                  <TabsContent value="conversions" hidden={activeTab !== "conversions"}>
                    <Card>
                      <CardHeader>
                        <CardTitle>Conversion History</CardTitle>
                        <CardDescription>Check your converted rewards.</CardDescription>
                      </CardHeader>
                      <CardContent>
                        <RewardsTable/>
                      </CardContent>
