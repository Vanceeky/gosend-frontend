  ...
  return (
    (<SidebarProvider>
      ...
      <SidebarInset>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <Card>
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                <CardTitle className="text-sm font-medium">Admin MotherWallet</CardTitle>
                <svg
            ...
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-xs text-red-700">50 Inactive Accounts</p>
              </CardContent>
            </Card>
        ...
        <div className="grid gap-4 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-7 p-2 md:px-6">
