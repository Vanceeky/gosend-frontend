...
const RewardsTable = () => {
  ...
  return (
        <>
            ...
            <TableBody>
                {paginatedData.map((rewards, index) => (
                <TableRow key={index}>
                    <TableCell>{rewards.receiver}</TableCell>
                    <TableCell>{rewards.amount}</TableCell>
                    <TableCell>{rewards.type}</TableCell>
                    <TableCell>{rewards.status}</TableCell>
                    <TableCell>{rewards.reference_id}</TableCell>
                    <TableCell>{rewards.date_created}</TableCell>
                    <TableCell>
